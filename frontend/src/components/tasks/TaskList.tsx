...
const TaskList: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-[var(--bg-secondary)]/80 backdrop-blur-sm rounded-2xl p-6 border border-[var(--glass-border)]">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-3">
              <div className="bg-[var(--bg-tertiary)]/80 backdrop-blur-sm rounded-lg px-4 py-2 border border-[var(--glass-border)] hover:shadow-md transition-all duration-200">
                <div className="flex items-center gap-2">
                  <div className="h-2.5 w-2.5 rounded-full bg-[var(--text-secondary)]"></div>
                  <span className="text-sm font-medium text-[var(--text-primary)]">{stats.total} Total</span>
                </div>
              </div>
              <div className="bg-[var(--bg-tertiary)]/80 backdrop-blur-sm rounded-lg px-4 py-2 border border-[var(--glass-border)] hover:shadow-md transition-all duration-200">
                <div className="flex items-center gap-2">
                  <div className="h-2.5 w-2.5 rounded-full bg-success"></div>
                  <span className="text-sm font-medium text-[var(--text-primary)]">{stats.completed} Completed</span>
                </div>
              </div>
              <div className="bg-[var(--bg-tertiary)]/80 backdrop-blur-sm rounded-lg px-4 py-2 border border-[var(--glass-border)] hover:shadow-md transition-all duration-200">
                <div className="flex items-center gap-2">
                  <div className="h-2.5 w-2.5 rounded-full bg-info"></div>
                  <span className="text-sm font-medium text-[var(--text-primary)]">{stats.inProgress} In Progress</span>
                </div>
              </div>
              <div className="bg-[var(--bg-tertiary)]/80 backdrop-blur-sm rounded-lg px-4 py-2 border border-[var(--glass-border)] hover:shadow-md transition-all duration-200">
                <div className="flex items-center gap-2">
                  <div className="h-2.5 w-2.5 rounded-full bg-warning"></div>
                  <span className="text-sm font-medium text-[var(--text-primary)]">{stats.pending} Pending</span>
                </div>
              </div>
              {stats.overdue > 0 && (
